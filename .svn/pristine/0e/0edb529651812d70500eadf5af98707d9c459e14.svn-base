...
$(function(){
		...
		$.ajax({
            ...
            success:function(data) {
            	...
            	if(result_code==201){
            		...
            		if(runType==3){
            			checkaccept_timer = window.setInterval(function(){
                    		$.ajax({
            		...
            		log_timer = window.setInterval(function(){
                		$.ajax({
	...
	var sendAction = function(actionType){
		//TODO
		var tableName='logic_'+flowId_global;
		$.ajax({
