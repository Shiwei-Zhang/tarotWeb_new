...
$(function(){
    $('.dataSe').change(function(){
        document.getElementsByClassName('showValue')[0].value=
			...
			$('.editUser').unbind('click').click(function (e) {
				...
				$.ajax({
					...
					success:function(data){
						...
						$('.edit-user .loginId').val(data.loginId);
...
function EditOkUser(){
	...
	jsonObj.loginId =$('.userEdit .loginId').val();
