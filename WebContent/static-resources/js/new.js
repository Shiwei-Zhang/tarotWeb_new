  ...
  //点击确定
    ...
    $('.add4').off('click').click(function () {
        ...
        $('.addInterface .addBtn').off('click').click(function () {
            ...
            $('.addInterface .paramMain').append('<li class="addInterfaceColumn"><input type="text" spellcheck="false" value="'+columnName+'"><select>'+
...
function editInterface(interfaceId,interfaceName){
	...
	$.each(columns, function( index, value ) {
		$('.editInterface .paramMain').append('<li class="editInterfaceColumn"><input type="text" spellcheck="false" columnid="'+value.id+'" columnlength="'+value.length+'" columnprecision="'+value.precision+'" columnscale="'+value.scale+'"  value="'+value.name+'">'+
				'<select>'+
...
//	给每一行删除绑定事件
    ...
    $('.editInterface .addBtn').off('click').click(function () {
    	var columnName = "column"+column_num;
        $('.editInterface .paramMain').append('<li class="editInterfaceColumn"><input type="text" spellcheck="false" value="'+columnName+'"><select>'+
        		'<option value="Integer">Integer</option>'+
				'<option value="Long">Long</option>'+
				'<option value="Boolean">Boolean</option>'+
				'<option value="BigDecimal">BigDecimal</option>'+
