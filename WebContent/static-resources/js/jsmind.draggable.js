    ...
    jsMind.draggable.prototype = {
        ...
        _create_tip:function(){
            ...
            if(container=="jsmind_container"){
            	showTip.innerHTML="<input type='button' value='断点' action='debug' onclick='set_flag(this,1);'></input></br><input type='button' value='数据出口' action='export' onclick='set_flag(this,2);'></input>";
            }else{
            	showTip.innerHTML='<ul>'+
                        '<li>Business_class</li>'+
                        '<li>Business_class</li>'+
                        '<li>Business_class</li>'+
                        '<li>Business_class</li></ul>'+
                        '<div><span class="sure">确定</span><span class="cancel">取消</span></div>';
            }
        ...
        move_node:function(src_node,target_node,target_direct){
            ...
            if(!!target_node && !!src_node && !jsMind.node.inherited(src_node, target_node)){
                ...
                if(flag){
                	...
                	//fuse_node(this.jm,node_before,beforeid);
                }
